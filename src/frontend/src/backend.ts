...
import type { ContactInfo as _ContactInfo, ExternalBlob as _ExternalBlob, ProfileData as _ProfileData, Publication as _Publication, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addPublication(arg0: string, arg1: string, arg2: string | null, arg3: ExternalBlob | null): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addPublication(arg0, arg1, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg2), await to_candid_opt_n9(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addResearchInterest(arg0: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async deletePublication(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteResearchInterest(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteResearchInterest(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPublication(arg0: string): Promise<Publication> {
        if (this.processError) {
            try {
                const result = await this.actor.getPublication(arg0);
                return from_candid_Publication_n22(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async setProfile(arg0: string, arg1: string, arg2: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setProfile(arg0, arg1, await to_candid_opt_n9(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePublication(arg0: string, arg1: string, arg2: string, arg3: string | null, arg4: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePublication(arg0, arg1, arg2, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg3), await to_candid_opt_n9(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ProfileData_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProfileData): Promise<ProfileData> {
    return await from_candid_record_n19(_uploadFile, _downloadFile, value);
}
async function from_candid_Publication_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Publication): Promise<Publication> {
...
async function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ProfileData]): Promise<ProfileData | null> {
    return value.length === 0 ? null : await from_candid_ProfileData_n18(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        pdf: record_opt_to_undefined(await from_candid_opt_n20(_uploadFile, _downloadFile, value.pdf)),
        title: value.title,
        link: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.link)),
...
async function from_candid_vec_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Publication>): Promise<Array<Publication>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Publication_n22(_uploadFile, _downloadFile, x)));
}
